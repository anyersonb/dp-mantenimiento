...
return [
    ...
    'name_reserved' => 'Ese nombre esta reservado por el sistema y no se puede reutilizar, aunque el rol original ya no exista.',
    'administration_restored_title' => 'Se repusieron permisos para no dejar el sistema sin administrador',
    'administration_restored_body' => 'Con lo que se guardo no quedaba ninguna cuenta activa capaz de entrar al panel y gestionar usuarios, asi que se le devolvieron a este rol: :permissions. Si de verdad quiere quitarselos, primero deje esos permisos en otro rol y asigneselo a alguien.',
    'administration_unreachable_title' => 'El sistema quedo sin nadie que pueda administrarlo',
    'administration_unreachable_body' => 'Ninguna cuenta activa puede entrar al panel y gestionar usuarios al mismo tiempo. Revise los permisos de los roles y las cuentas activas antes de cerrar sesion: desde el panel esto ya no se puede arreglar.',
