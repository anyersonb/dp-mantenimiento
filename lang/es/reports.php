...
return [
    ...
    'detail_in_files' => 'Despliegue cada máquina para ver su detalle completo (quién, dónde, checklist y repuestos uno por uno). El mismo detalle también está en el PDF y en el Excel.',
    'print' => 'Imprimir',
