...
return [
    ...
    'filters' => 'Filtros',
    'machines' => 'Máquinas',
    'machines_help' => 'Se eligen de las máquinas cargadas. Sin ninguna marcada, entran todas.',
    'locations' => 'Obras',
    ...
    'detail_help' => 'Elija una máquina para ver sus órdenes de trabajo del periodo: qué trabajo se hizo, quién, dónde y en qué se gastó.',
    'detail_machine' => 'Máquina',
    'detail_pick_machine' => 'Elija una máquina',
    'detail_none_selected' => 'Elija una máquina arriba para ver su detalle.',
    'detail_machine_gone' => 'La máquina elegida no aparece con los filtros puestos. Elija otra.',
    'detail_spend' => 'Gastado en el periodo',
    'work_description' => 'Trabajo',
    'no_description' => 'Sin descripción cargada en la orden de trabajo.',
    'job_number' => 'N.º de trabajo',
    'detail_in_files' => 'Éste es el detalle completo de la máquina elegida (quién, dónde, checklist y repuestos uno por uno). El de todas juntas está en el PDF y en el Excel.',
    'print' => 'Imprimir',
